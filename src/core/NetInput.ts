...
export class NetInput {
  ...
  private _inputSize: number | undefined = undefined;
  ...
  public getInput(batchIdx: number): tf.Tensor3D  | tf.Tensor4D {
  ...
  /**
   * Create a batch tensor from all input tensors
   * with size [batchSize, inputSize, inputSize, 3].
   *
   * @param inputSize Height and width of the tensor.
   * @param isCenterImage (optional, default: true) If true, add an equal amount of padding on
